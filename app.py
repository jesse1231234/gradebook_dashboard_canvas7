...
def gradebook_prepare_for_dashboard(df_proc: pd.DataFrame, student_col="Student", section_col="Section", final_col="Final Grade"):
    ...
    return {"data":data.reset_index(drop=True),"final_col":final_col if final_col in df_proc.columns else None,
            ...
            "assign_cols":assign_cols,"pct_df":pct_df,"missing":miss_df,"excused":exc_df,"points":pts,
...
if st.session_state.stage == "welcome":
    ...
    # DASHBOARD (same charts/tables as in prior build, using stored bytes)
